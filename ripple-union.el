...
(defun request-trust (amount)
  ...
  (interactive "nAmount: ")
  (insert "THIS EMAIL IS IMPORTANT.  PLEASE READ IT CAREFULLY BEFORE PROCEEDING.")
  (fill-paragraph)
  (insert (format "\n\nWe have activated your account, but before we can complete your transaction, you will need to set up a trust line with r3ADD8kXSUKHd6zTCKfnKT3zV9EZHjzp1S for at least %d CAD.  You can do this by following the link below:" amount))
  (fill-paragraph)
  (insert "\n\n")
  (trust-url amount)
